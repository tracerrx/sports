...
aarch64|armv7l)
  ...
  latesturl="https://api.github.com/repos/tracerrx/sports/releases/latest"
...
armv6l)
  ...
  wget -q "https://github.com/tracerrx/sports/releases/download/v0.0.83/sportsmatrix-0.0.83_armv6l.deb"
  ;;
*)
